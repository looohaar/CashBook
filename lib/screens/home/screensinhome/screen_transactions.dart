                    ...
                    itemBuilder: (BuildContext context, int index){
                      return ListTile(
                        ...
                        onTap: (){
                          ...
                          // *********************amount**************
                          trailing: Text('Rs. ${transactionTileList[index].amount}',
                          ...
                          // ************category**************
                           title: Text(transactionTileList[index].categories,
                           style: GoogleFonts.signika(fontSize: 25,
                           fontWeight: FontWeight.bold,
                           color: transactionTileList[index].transactionType
                           ?tileIncomeColor
                           :tileExpenseColor),
                           ),
                        ...
                        // ******************date*****************
                             ...
                             borderRadius: BorderRadius.circular(20),
                               ...
                               child: Center(
                                 child: Text(DateFormat('EE, d MMM').format(transactionTileList[index].date),
